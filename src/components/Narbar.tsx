  ...
  return (
    <header className="bg-white">
      {pathname !== "/login" && pathname !== "/register" && (
        <div className="p-5 flex flex-col justify-between md:min-h-screen">
          <div>
            {/* name space  */}
          ...
          <div className="">
            {sessionStatus === "authenticated" ? (
              ...
              >
                <button className="px-4 py-2 hover:bg-red-500 rounded-[12px]">
                  Sign Out
                </button>
              </div>
            ) : (
              <ul className="flex gap-4">
                <Link href={"/login"}>
                  <button className="px-4 py-2 hover:bg-gray-200 rounded-[12px] w-[100px]">
                    Login
                  </button>
                </Link>
                <Link href={"/register"}>
                  <button className="px-4 py-2 hover:bg-gray-400 rounded-[12px] w-[100px]">
                    Register
                  </button>
                </Link>
              </ul>
